...
parser.add_argument('--enable_input', type=int, choices=[0, 1], default=0, help='Whether to enable typing input for HID device (0 or 1)')
...
python mount_robot.py --type HID --vid 0x1234 --pid 0x5678 --enable_input 1 --input "hello world"       # HID device  
...
class DeviceOperator():
    ...
    def operate_device(self):
        ...
        if self._isMSC():
            ...
            self.device.usb_device = HID(self.device_desc, DeviceFunction.hid.value, enable=self.args.enable_input, input_string=self.args.input)
