...
class Ui_SSHHelper(object):
    def setup_ui(self, Form):
        ...
        self.appendMarkdown("`==========================`  ")
        self.appendMarkdown("## SSH Conf:")
        self.appendMarkdown("`---------------`")
        self.appendMarkdown("**IP**: Raspberry Pi IP address, which could be checked in router, please check `readme.txt`")
        self.appendMarkdown("**Port**: 22")
        self.appendMarkdown("**User**: pi")
        self.appendMarkdown("**Key**: raspberry")
        self.appendMarkdown("**Log**: `*.log`")
        self.appendMarkdown("## WiFi:")
        self.appendMarkdown("`---------------`")
        self.appendMarkdown("**SSID**: all visiable WiFi network name on current machine")
        ...
        self.appendMarkdown("**Cancel**: close the Raspi SSH Connection without saving parameter")
...
class Ui_RaspiSshConnection(QMainWindow):
    ...
    def setup_ui(self, RaspiSshConnection:QtWidgets.QDialog):
        ...
        RaspiSshConnection.setWindowTitle("Raspi SSH Connection")
        self.groupBox_SSH.setTitle("SSH Conf")
        self.LB_IP.setText("IP Address")
        self.LE_IP.setPlaceholderText("Raspiberry Pi device IP")
        ...
        self.LE_User.setPlaceholderText("Raspberry Pi Username: pi")
        self.LE_User.setText(self.setup_dict["SSHConf"]["User"])
        self.LB_Key.setText("Key")
        self.LE_Key.setPlaceholderText("Raspberry Pi login password: raspberry")
